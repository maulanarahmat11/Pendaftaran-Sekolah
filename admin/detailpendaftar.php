                ...
                <div class="card-body">
                    <div class="card-body">
                        <div class="col-auto mt-3 text-center">
                            ...
                            ?>
                            <img src="<?= $foto ?>" alt="fotoprofil" class="img-fluid rounded-circle" style="width: 200px">
                        </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="card-body">
                        ...
                        <!-- Tombol Button -->
                        <button type="button" class="btn btn-primary mt-3 btn-block" data-toggle="modal" data-target="#modalvalidasi">Validasi Data Pendaftar</button>
