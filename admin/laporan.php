...
<div class="container-fluid">
    ...
    <a href="<?= $base_url ?>/cetak/data_pendaftar.php" class="btn btn-warning btn-sm mb-4" target="_blank">Cetak Data Pendaftar PDF</a>
    <a href="<?= $base_url ?>/cetak/data_excel.php" class="btn btn-success btn-sm mb-4" target="_blank">Cetak Data Pendaftar EXCEL</a>
